...
func (m *MockECSClient) RunTask(arg0 *ecs.RunTaskInput) (*ecs.RunTaskOutput, error) {
...
func (_mr *_MockECSClientRecorder) RunTask(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "RunTask", reflect.TypeOf((*MockECSClient)(nil).RunTask), arg0)
}
