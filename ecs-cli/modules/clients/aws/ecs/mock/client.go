...
func (_m *MockECSClient) CreateService(_param0 string, _param1 string, _param2 *ecs0.LoadBalancer, _param3 string, _param4 *ecs0.DeploymentConfiguration, _param5 *ecs0.NetworkConfiguration, _param6 string) error {
...
func (_m *MockECSClient) RunTask(_param0 string, _param1 string, _param2 int, _param3 *ecs0.NetworkConfiguration, _param4 string) (*ecs0.RunTaskOutput, error) {
...
func (_m *MockECSClient) UpdateService(_param0 string, _param1 string, _param2 int64, _param3 *ecs0.DeploymentConfiguration, _param4 *ecs0.NetworkConfiguration) error {
...
func (_m *MockECSClient) UpdateServiceCount(_param0 string, _param1 int64, _param2 *ecs0.DeploymentConfiguration, _param3 *ecs0.NetworkConfiguration) error {
