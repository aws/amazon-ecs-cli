...
type ECSClient interface {
	...
	RunTask(taskDefinition, taskGroup string, count int) (*ecs.RunTaskOutput, error)
...
func (c *ecsClient) RunTask(taskDefinition, group string, count int) (*ecs.RunTaskOutput, error) {
